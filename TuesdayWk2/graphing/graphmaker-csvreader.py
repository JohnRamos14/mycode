...
def parsecsvdata():
    ...
    # open csv data
    with open("/home/student/mycode/TuesdayWk2/graphing/2018summary.csv", "r") as downtime:
        print(downtime.read())
        ...
        for row in downdata:
            ...
            summary.append(rowdat) # add dict to lisit
    return summary
...
def main():
    ...
    plt.savefig("/home/student/mycode/TuesdayWk2/graphing/2018summaryv2.png")
    # Save to "~/static"
